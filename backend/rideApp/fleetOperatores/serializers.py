...
class FleetOparetoreSerializer(serializers.ModelSerializer):
    class Meta:
        model = FleetOparetore
        fields = [
            ...
            'delete_oparetore', 'deleted_at','language','status','date_of_birth','fleet_income'
        ]
    ...
    def create(self, validated_data):
        ...
        last_operator = FleetOparetore.objects.all().order_by('-oparetore_id').first()
